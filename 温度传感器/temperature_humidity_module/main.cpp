...
GPIO G(GPIOA,11,GPIO_Mode_Out_PP,GPIO_Speed_50MHz);
...
//网络连接	
	...
	tskmgr.DelayMs(1000);
//	wifi.joinAP("FFF","f19940202");
	tskmgr.DelayMs(1000);
	wifi.enableOrDisableMUX(1);//开启多路访问
	tskmgr.DelayMs(1000);
	wifi.ConnectServerID(0,"TCP","192.168.191.1",8080);
	tskmgr.DelayMs(1000);
...
//		tskmgr.DelayMs(1000);
		...
		if(am2302.Updata()==1)
		{
			wifi.Send(0,20,packaging.temperatureModuleToModule(am2302.DHT22_data[2],am2302.DHT22_data[3],0));
			wifi.Send(0,20,packaging.humidityModuleToModule(am2302.DHT22_data[0],am2302.DHT22_data[1],0));
			tskmgr.DelayMs(1000);
		}
	}
